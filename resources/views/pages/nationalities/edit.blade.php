    ...
    <form action="{{route('nationalities.update',$nationality->id)}}" method="post">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Edit Nationality - {{$nationality->name}}</h6>
            </div>
            <!-- Card Body -->
            <div class="card-body">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input class="form-control {{$errors->has('name')?'border-danger':''}}" type="text"
                                   id="name"
                                   name="name" value="{{old('name',$nationality->name)}}">
                            @if($errors->has('name'))
            ...
            <div class="card-footer">
                <div class="text-center">
                    ...
                    <a href="{{route('nationalities.index')}}" class="btn btn-sm">Cancel</a>
                </div>
            </div>
        </div>
